...
func Resource(k client.Object, f resourceFactory) *resourceComponent {
...
func (comp *resourceComponent) Kind() client.Object {
	return comp.kind
}

func (comp *resourceComponent) Reconcile(ctx *core.Context) (ctrl.Result, error) {
