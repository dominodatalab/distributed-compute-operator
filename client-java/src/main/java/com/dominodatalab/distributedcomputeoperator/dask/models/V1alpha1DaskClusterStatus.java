...
public class V1alpha1DaskClusterStatus {
  ...
  public V1alpha1DaskClusterStatus image(String image) {
  ...
  **/
  ...
  public V1alpha1DaskClusterStatus nodes(List<String> nodes) {
    
    this.nodes = nodes;
    return this;
  }

  public V1alpha1DaskClusterStatus addNodesItem(String nodesItem) {
    if (this.nodes == null) {
  ...
  **/
  ...
  public V1alpha1DaskClusterStatus workerReplicas(Integer workerReplicas) {
  ...
  **/
  ...
  public V1alpha1DaskClusterStatus workerSelector(String workerSelector) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1DaskClusterStatus v1alpha1DaskClusterStatus = (V1alpha1DaskClusterStatus) o;
    return Objects.equals(this.image, v1alpha1DaskClusterStatus.image) &&
        Objects.equals(this.nodes, v1alpha1DaskClusterStatus.nodes) &&
        Objects.equals(this.workerReplicas, v1alpha1DaskClusterStatus.workerReplicas) &&
        Objects.equals(this.workerSelector, v1alpha1DaskClusterStatus.workerSelector);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1DaskClusterStatus {\n");
