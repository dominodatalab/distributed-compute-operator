...
/**
 * V1alpha1RayClusterSpecHeadSecurityContextWindowsOptions
 */
...
public class V1alpha1RayClusterSpecHeadSecurityContextWindowsOptions {
  ...
  public V1alpha1RayClusterSpecHeadSecurityContextWindowsOptions gmsaCredentialSpec(String gmsaCredentialSpec) {
  ...
  **/
  ...
  public V1alpha1RayClusterSpecHeadSecurityContextWindowsOptions gmsaCredentialSpecName(String gmsaCredentialSpecName) {
  ...
  **/
  ...
  public V1alpha1RayClusterSpecHeadSecurityContextWindowsOptions runAsUserName(String runAsUserName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1RayClusterSpecHeadSecurityContextWindowsOptions v1alpha1RayClusterSpecHeadSecurityContextWindowsOptions = (V1alpha1RayClusterSpecHeadSecurityContextWindowsOptions) o;
    return Objects.equals(this.gmsaCredentialSpec, v1alpha1RayClusterSpecHeadSecurityContextWindowsOptions.gmsaCredentialSpec) &&
        Objects.equals(this.gmsaCredentialSpecName, v1alpha1RayClusterSpecHeadSecurityContextWindowsOptions.gmsaCredentialSpecName) &&
        Objects.equals(this.runAsUserName, v1alpha1RayClusterSpecHeadSecurityContextWindowsOptions.runAsUserName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1RayClusterSpecHeadSecurityContextWindowsOptions {\n");
