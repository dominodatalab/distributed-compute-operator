...
public class V1alpha1RayClusterStatus {
  ...
  public V1alpha1RayClusterStatus image(String image) {
  ...
  **/
  ...
  public V1alpha1RayClusterStatus nodes(List<String> nodes) {
    
    this.nodes = nodes;
    return this;
  }

  public V1alpha1RayClusterStatus addNodesItem(String nodesItem) {
    if (this.nodes == null) {
  ...
  **/
  ...
  public V1alpha1RayClusterStatus workerReplicas(Integer workerReplicas) {
  ...
  **/
  ...
  public V1alpha1RayClusterStatus workerSelector(String workerSelector) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1RayClusterStatus v1alpha1RayClusterStatus = (V1alpha1RayClusterStatus) o;
    return Objects.equals(this.image, v1alpha1RayClusterStatus.image) &&
        Objects.equals(this.nodes, v1alpha1RayClusterStatus.nodes) &&
        Objects.equals(this.workerReplicas, v1alpha1RayClusterStatus.workerReplicas) &&
        Objects.equals(this.workerSelector, v1alpha1RayClusterStatus.workerSelector);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1RayClusterStatus {\n");
