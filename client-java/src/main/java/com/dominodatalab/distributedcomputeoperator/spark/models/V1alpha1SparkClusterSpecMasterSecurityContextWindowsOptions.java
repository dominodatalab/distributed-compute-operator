...
/**
 * V1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions
 */
...
public class V1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions {
  ...
  public V1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions gmsaCredentialSpec(String gmsaCredentialSpec) {
  ...
  **/
  ...
  public V1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions gmsaCredentialSpecName(String gmsaCredentialSpecName) {
  ...
  **/
  ...
  public V1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions runAsUserName(String runAsUserName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions v1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions = (V1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions) o;
    return Objects.equals(this.gmsaCredentialSpec, v1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions.gmsaCredentialSpec) &&
        Objects.equals(this.gmsaCredentialSpecName, v1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions.gmsaCredentialSpecName) &&
        Objects.equals(this.runAsUserName, v1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions.runAsUserName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1SparkClusterSpecMasterSecurityContextWindowsOptions {\n");
